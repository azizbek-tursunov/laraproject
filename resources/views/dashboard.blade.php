            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    @if (auth()->user()->role->name == 'manager')
                        <span class="text-2xl font-bold text-green-600">Aplications</span>
                        <!-- component -->
                            ...
                            <div class="rounded-xl border p-5 shadow-md w-9/12 bg-white">
                                <div class="flex w-full items-center justify-between border-b pb-3">
                                    ...
                                    <div class="flex items-center space-x-8">
                                        ...
                                        <div class="text-xs text-neutral-500">2023-03-17</div>
                                    </div>
                                </div>
                            ...
                            <div class='w-full max-w-lg px-10 py-8 mx-auto bg-white rounded-lg shadow-xl'>
                                <div class='max-w-md mx-auto space-y-6'>
                                    ...
                                    <form action="{{ route('applications.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <label class="uppercase text-sm font-bold opacity-70">Message
                                            <textarea rows="4" name="message" required class="p-3 mt-2 mb-4 w-full bg-slate-200 rounded"></textarea>
                                        </label>
                                        <label class="uppercase text-sm font-bold opacity-70">File
